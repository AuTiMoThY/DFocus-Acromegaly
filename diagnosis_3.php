...
?>
<title>診斷及治療:生化值的檢驗方法 | 肢端肥大症-衛教資訊網</title>
...
<main id="mainPage" class="layout-md">
	<div class="cnt_warpper">
		<div class="container">
			<header class="cnt_hd">
				<h1 class="txt_title-title-diagnosis_3 hide_txt">診斷及治療:生化值的檢驗方法</h1>
			</header>
			<article class="cnt_md diagnosis_3">
				<section class="">
				<div class="editorDF">
					<img src="<?php path_au('img'); ?>pic-diagnosis_3.png" alt="">
				</div>
				</section>
		...
		<div class="change_page clearfix">
			<span class="prev left"><a href="<?php webPageUrlAu('diagnosis_2'); ?>" class="ib">檢驗流程</a></span>
			<span class="next right"><a href="<?php webPageUrlAu('diagnosis_4'); ?>" class="ib">治療目標</a></span>
		</div>
