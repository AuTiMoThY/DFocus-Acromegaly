...
?>
<title>與肢端肥大症共存 | 肢端肥大症-衛教資訊網</title>
...
<main id="mainPage" class="layout-md">
	<div class="cnt_warpper">
		<div class="container">
			<header class="cnt_hd">
				<h1 class="txt_title-title-coexisting_2 hide_txt">與肢端肥大症共存</h1>
			</header>
			<article class="cnt_md coexisting_2">
				<section class="">
				<div class="editorDF">
					<img src="<?php path_au('img'); ?>pic-coexisting_2.png" alt="">
				</div>
		...
		<div class="change_page clearfix">
			<span class="prev left"><a href="<?php webPageUrlAu('coexisting_1'); ?>" class="ib">疾病控制重要性</a></span>
			<span class="next right"><a href="<?php webPageUrlAu('coexisting_3'); ?>" class="ib">與醫療團隊合作</a></span>
		</div>
