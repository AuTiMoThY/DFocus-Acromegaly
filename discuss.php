...
<title>病友互動討論區 | 肢端肥大症-衛教資訊網</title>
...
// -------------------------------
 ...
 ?>
<link rel="stylesheet" href="plugin/Validation-Engine/validationEngine.jquery.css" />
<?php
//app
...
<main id="mainPage" class="layout-md">
	<div class="cnt_warpper">
		<div class="container">
			<header class="cnt_hd">
				<h1 class="txt_title-title-discuss hide_txt">病友互動討論區</h1>
			</header>

			<article class="cnt_md faq">
				<section class="discuss-wrap cf">
					<aside class="left">
...
$(function() {
	createCode();
	$("#ForumForm").validationEngine('attach', {promptPosition : "CenterRight: -50, 50", scroll: true});
});
