...
?>
<title>與肢端肥大症共存:控制肢端肥大症的重要性 | 肢端肥大症-衛教資訊網</title>
...
<main id="mainPage" class="layout-md">
	<div class="cnt_warpper">
		<div class="container">
			<header class="cnt_hd">
				<h1 class="txt_title-title-coexisting_1 hide_txt">與肢端肥大症共存:控制肢端肥大症的重要性</h1>
			</header>
			<article class="cnt_md coexisting_1">
				<section class="">
				<div class="editorDF">
					<img src="<?php path_au('img'); ?>pic-coexisting_1.png" alt="">
				</div>
		...
		<div class="change_page clearfix">
			<span class="next right"><a href="<?php webPageUrlAu('coexisting_2'); ?>" class="ib">如何與疾病共存</a></span>
		</div>
